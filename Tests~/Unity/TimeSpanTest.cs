...
namespace Ipfs.Unity
{
    ...
    public class TimeSpanTest
    {
        ...
        public void ToShortString() 
        {
            ...
            Assert.AreEqual("24h", new TimeSpan(1, 0, 0, 0).ToShortString());
            ...
            Assert.AreEqual("120h", new TimeSpan(5, 0, 0, 0).ToShortString());

            Assert.AreEqual("3m1s", new TimeSpan(0, 0, 3, 1).ToShortString());
            Assert.AreEqual("4h2s", new TimeSpan(0, 4, 0, 2).ToShortString());
            Assert.AreEqual("143h59m59s", new TimeSpan(5, 23, 59, 59).ToShortString());
