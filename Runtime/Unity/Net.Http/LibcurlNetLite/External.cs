...
namespace Unity.Libcurl
{
    ...
    internal class External
    {
        ...
        private const string m_libCurlShim = "LibCurlShim";
        ...
        // curl_easy_setopt polymorphism
        [DllImport(m_libCurlBase, CallingConvention = CallingConvention.Cdecl)]
        internal static extern CURLcode curl_easy_setopt(IntPtr pCurl, CURLoption opt, IntPtr parm);
        [DllImport(m_libCurlBase, CallingConvention = CallingConvention.Cdecl)]
        internal static extern CURLcode curl_easy_setopt(IntPtr pCurl, CURLoption opt, int parm);
        [DllImport(m_libCurlBase, CallingConvention = CallingConvention.Cdecl)]
        internal static extern CURLcode curl_easy_setopt(IntPtr pCurl, CURLoption opt, long parm);
        [DllImport(m_libCurlBase, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        internal static extern CURLcode curl_easy_setopt(IntPtr pCurl, CURLoption opt, [MarshalAs(UnmanagedType.LPStr)] string parm);
        [DllImport(m_libCurlBase, CallingConvention = CallingConvention.Cdecl)]
        internal static extern CURLcode curl_easy_setopt(IntPtr pCurl, CURLoption opt, byte[] parm);
        [DllImport(m_libCurlBase, CallingConvention = CallingConvention.Cdecl)]
        internal static extern CURLcode curl_easy_setopt(IntPtr pCurl, CURLoption opt, CURL_READ_DELEGATE parm);
        [DllImport(m_libCurlBase, CallingConvention = CallingConvention.Cdecl)]
        internal static extern CURLcode curl_easy_setopt(IntPtr pCurl, CURLoption opt, CURL_WRITE_DELEGATE parm);
        ...
        [DllImport(m_libCurlShim, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        internal static extern IntPtr curl_shim_add_string_to_slist(IntPtr pStrings, String str);
        [DllImport(m_libCurlShim, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        internal static extern IntPtr curl_shim_get_string_from_slist(IntPtr pSlist, ref IntPtr pStr);
        [DllImport(m_libCurlShim, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(m_libCurlShim, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void curl_shim_get_file_time(int unixTime, ref int yy, ref int mm, ref int dd, ref int hh, ref int mn, ref int ss);
        [DllImport(m_libCurlShim, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(m_libCurlShim, CallingConvention = CallingConvention.Cdecl)]
        internal static extern CURLMcode curl_shim_multi_fdset(IntPtr multi, IntPtr fdsets, ref int maxFD);
        [DllImport(m_libCurlShim, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int curl_shim_select(int maxFD, IntPtr fdsets, int timeoutMillis);
        [DllImport(m_libCurlShim, CallingConvention = CallingConvention.Cdecl)]
        internal static extern IntPtr curl_shim_multi_info_read(IntPtr multi, ref int nMsgs);
        [DllImport(m_libCurlShim, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(m_libCurlShim, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int curl_shim_install_share_delegates(IntPtr pShare, IntPtr pThis, CURLSH_LOCK_DELEGATE pLock, CURLSH_UNLOCK_DELEGATE pUnlock);
        [DllImport(m_libCurlShim, CallingConvention = CallingConvention.Cdecl)]
